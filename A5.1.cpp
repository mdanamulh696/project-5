...
public:
    ...
    float annual_kwh()
    {
        return (((this->annual_hours_of_use() * this->watt)
            + (this->annual_hours_of_standby() * this->watt_standby)) / 1000);
    }
...
private:
    ...
    // Assuming you have a 'consumer' class defined
    Consumer* consumers;
...
public:
    ...
    // Assuming you have a 'get_consumers()' method in the consumer class
    Consumer* get_consumers() { return consumers; }
    ...
    // Assuming you have a 'set_consumers()' method in the consumer class
    void set_consumers(Consumer* newConsumers) { consumers = newConsumers;}
